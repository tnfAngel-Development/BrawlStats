// External imports
import { addColors, createLogger, transports, format, Logger } from 'winston';

export class BrawlStatsClientLoggerColors {
...
export class BrawlStatsClientLogger {
	...
	logger: Logger;
	constructor() {
		this.logColors = new BrawlStatsClientLoggerColors();
		...
		const getDate = () => {
			const zeroFormat = (digits: number | string) => {
